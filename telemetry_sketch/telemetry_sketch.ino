...
float pressure, temp_c, altitude_m;
// End Pressure Init
...
{ 
  ...
  altitude_m = PressureSensor.readFloatAltitudeMeters();  //Locally Adjusted Altitude (m)
...
void printtelem(void)
{
  ...
  Serial.print(", Locally Adjusted Altitude: "); Serial.print(altitude_m, 2);
